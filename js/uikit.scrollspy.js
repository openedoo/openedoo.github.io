...
function(t, e, i) {
    ...
    var o = !1,
        s = t("html"),
        a = '<div class="uk-modal"><div class="uk-modal-dialog"></div></div>',
        r = function(i, n) {
            var o = this;
    ...
    t.extend(r.prototype, {
        ...
        resize: function() {
            ...
            var t = parseInt(this.dialog.css("width"), 10),
                e = t + parseInt(this.dialog.css("margin-left"), 10) + parseInt(this.dialog.css("margin-right"), 10) < i.width();
    ...
    var l = function(e, i) {
        ...
        }, i), this.element = o, this.modal = new r(this.options.target, i), o.on("click", function(t) {
    ...
    var i = function(e, n) {
        ...
        if (!s.data("switcher")) {
            if (this.options = t.extend({}, i.defaults, n), this.element = s.on("click", this.options.toggler, function(t) {
                ...
                var a = this.element.find(this.options.toggler),
    ...
    t.extend(n.prototype, {
        ...
        trigger: function() {
            ...
            return this.value = this.input.val(), this.value.length < this.options.minLength ? this.hide() : (this.value != e && (this.timer && window.clearTimeout(this.timer), this.timer = window.setTimeout(function() {
                i[t.options.param] = t.value, t.request({
                    data: i
                })
